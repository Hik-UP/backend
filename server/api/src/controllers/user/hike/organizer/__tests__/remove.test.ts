...
describe('DELETE /user/hike/organizer/remove', () => {
  it('should return 401', async () => {
    const res = await request(httpsServer)
      .delete('/api/user/hike/organizer/remove')
      .send({
        user: {
          id: User.userId,
          roles: User.roles
...
describe('DELETE /api/user/hike/organizer/remove', () => {
...
describe('DELETE /api/user/hike/organizer/remove', () => {
  ...
  it('should return 201', async () => {
    ...
    for (let i = 0; i < 10; i += 1) {
      ...
      expect(res.body.hikes.organized.length).toEqual(1);
      expect(res.body.hikes.attendee.length).toEqual(1);
